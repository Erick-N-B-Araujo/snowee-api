...
def main():
    ...
    if "response" in payload_dict and "body" in payload_dict["response"]:
        ...
        try:
            ...
            #root.Body[ipe][ipt].Country = "Brazil"
            root.Body[ipe][ipt].City = "São Paulo"

            #objectify.deannotate(root.Body[ipe][ipt].Country)
            #etree.cleanup_namespaces(root.Body[ipe][ipt].Country)
